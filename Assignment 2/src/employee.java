...
public class employee extends rentalCar{ //1.3 User-defined class
	...
	employee (){ // 1.4 Constructor with one arguments
		...
		String []employee = {"Ali \t\t(Manager)", "Abu \t\t(Cashier)", "Amin \t\t(Stock manager)", "Aminah \t\t(Mechanic)\t"};
...
public void printInfo() { //2.2 Polymorphism
		...
		System.out.println("Important note /n All must work from home during covid");
