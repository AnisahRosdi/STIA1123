...
public class Login extends JFrame {
	...
	public Login() {
		...
		txtUsername.setBackground(new Color(102, 0, 153));
		...
		btnUser.setBackground(new Color(204, 51, 255));
...
if (txtUsername.getText().equals("Admin") && (txtPassword.getText().equals("1234"))) {
		...
		btnAdmin.setBackground(new Color(204, 51, 255));
		...
		txtPassword.setBackground(new Color(102, 0, 153));
		...
		btnReset.setBackground(new Color(204, 51, 255));
